...
prompts = [
    "Stig till: 4 000 fot", # Cue 1
    "Sväng höger: 120 grader\nBehåll 4 000 fot", # Cue 2
    "Alla system fungerar normalt", # Cue 3
    "Sväng höger: 120 grader\nBehåll 4 000 fot", # Cue 4
    "Sjunk till 2 500 fot\nBehåll kurs 120 grader", # Cue 5
    "Sväng vänster: 30 grader\nStig till 3 500 fot", # Cue 6
    "Bränslenivå: Stabil", # Cue 7
    "Sväng vänster: 30 grader\nStig till 3 500 fot",  # Cue 8
    "Sikt: Mycket god", # Cue 9
    "Sväng vänster: 30 grader\nStig till 3 500 fot", # Cue 10
    "Sessionen avslutad\nTack!" # Cue 11
...
audio_files = [
    "audio/s4000f.wav",
    "audio/h120b4000f.wav",
    "audio/systemnormalt.wav",
    None,
    "audio/2500fk120.wav",
    "audio/v30s3500f.wav",
    "audio/bransle.wav",
